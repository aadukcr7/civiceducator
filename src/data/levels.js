    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          ...
          'Convert organic waste to fertilizer',
          'Burn plastics',
          'Pollute rivers',
        ],
        correct: 1,
  ...
  },
  {
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          'Drive home',
          'Use public transport or designated driver',
          'Speed to arrive faster',
          'Ignore traffic laws',
        ],
        correct: 1,
      },
      ...
      },
      {
        ...
        options: [
          'Increase costs',
          'Ensure brakes/lights/tires are safe',
          'Decorate vehicles',
          'Avoid insurance',
        ],
        correct: 1,
  ...
  },
  {
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          'Reduce tourism',
          'Balance ecosystems and preserve species',
          'Eliminate forests',
          'Increase poaching',
        ],
        correct: 1,
  ...
  },
  {
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          'None exist',
          'Caste-based Discrimination Act',
          'Traffic Act',
          'Property Tax Act',
        ],
        correct: 1,
      },
      {
        ...
        options: [
          ...
          'Rights to culture and self-governance',
          'Forced relocation',
          'No representation',
        ],
        correct: 1,
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          ...
          'Verify before posting and report abuse',
          'Share passwords',
          'Click all links',
        ],
        correct: 1,
...
function appendAdditionalLessons(baseLessons, levelId) {
  ...
  let nextId = lessons.length
    ? Math.max(...lessons.map((lesson) => Number(lesson.id) || 0)) + 1
    : levelId * 100 + 1;
